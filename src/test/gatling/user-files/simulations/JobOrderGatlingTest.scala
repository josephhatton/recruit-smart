...
class JobOrderGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the JobOrder entity")
        ...
        .repeat(2) {
            ...
            .post("/api/job-orders")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "duration":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "salary":"SAMPLE_TEXT", "hourly":"SAMPLE_TEXT", "jobType":null, "jobStatus":null}""")).asJSON
            .check(status.is(201))
