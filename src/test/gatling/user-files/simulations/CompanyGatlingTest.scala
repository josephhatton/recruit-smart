...
class CompanyGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Company entity")
        ...
        .repeat(2) {
            ...
            .post("/api/companies")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "website":"SAMPLE_TEXT", "industry":"SAMPLE_TEXT", "revenue":"SAMPLE_TEXT", "employee":"SAMPLE_TEXT", "isDeleted":null, "companyType":null, "companyStatus":null}""")).asJSON
            .check(status.is(201))
