...
public class SkillCategoryResourceIntTest {
    ...
    public void setup() {
        ...
        final SkillCategoryResource skillCategoryResource = new SkillCategoryResource(skillCategoryRepository, skillCategorySearchRepository);
    ...
    public void createSkillCategory() throws Exception {
        ...
        assertThat(skillCategoryEs).isEqualToIgnoringGivenFields(testSkillCategory);
    }
    ...
    public void updateSkillCategory() throws Exception {
        // Initialize the database
        skillCategoryRepository.saveAndFlush(skillCategory);
        skillCategorySearchRepository.save(skillCategory);
        ...
        updatedSkillCategory.setName(UPDATED_NAME);
